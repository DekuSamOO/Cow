...
# ⚠️ 防守為條件式（2026-07-04 拍板）：每階執行前先看當下 bottom_floors 的
#   final_low / ensemble_low；第 3 階（關馬2）僅當模型熊底 > $33,000 才執行，否則跳過、
#   0.165 BTC 留現貨（全防守後強平 ~$31.2k 與模型熊底點估同區，見數學稽核 §3.1）。
