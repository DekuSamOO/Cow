...
from handler._cache import cached_figure, macro_compass_cache, make_bb_cache_key
...
def render(btc, chart_df, tvl_hist, stable_hist, fund_hist,
    ...
    @cached_figure(CowCacheNamespace("mc_compass"), make_bb_cache_key)
    def _build_hist_figure(btc_df):
