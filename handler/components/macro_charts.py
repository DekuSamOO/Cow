...
from handler._cache import cached_figure, macro_compass_cache, make_mc_cache_key
...
def render(btc, chart_df, tvl_hist, stable_hist, fund_hist,
    ...
    @cached_figure(macro_compass_cache, make_mc_cache_key)
    def _build_main_figure(chart_df, tvl_hist, stable_hist, fund_hist):
        _cdf = chart_df.copy()
    ...
    fig_main = _build_main_figure(chart_df, tvl_hist, stable_hist, fund_hist)
